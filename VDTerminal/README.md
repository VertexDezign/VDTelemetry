...
| **Fields** | what is on the farm's land: every field as a row with its crop, its area, its price if it is for sale, and what state the ground is in — the last counted across the whole field off the growth raster rather than sampled at its centre, so a field half cut reads as half cut — filterable to what is yours, what is for sale, what needs work and what is ready, and cross-linked to the map |
