...
import net.vertexdezign.vdt.Environment
...
@Composable
fun Header(env: Environment?, vehicle: Vehicle?, onMenuClick: () -> Unit = {}) {
    ...
    Row(
        ...
        // Left third
        Row(Modifier.weight(1f), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(24.dp)) {
            Icon(Icons.Filled.Menu, "menu", tint = accent.text, modifier = Modifier.size(24.dp).clickable(onClick = onMenuClick))
        ...
        Row(Modifier.weight(1f), horizontalArrangement = Arrangement.spacedBy(16.dp, Alignment.End), verticalAlignment = Alignment.CenterVertically) {
